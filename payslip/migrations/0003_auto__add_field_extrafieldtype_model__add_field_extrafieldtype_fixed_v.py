...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtraFieldType.model'
        db.add_column('payslip_extrafieldtype', 'model',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExtraFieldType.fixed_values'
        db.add_column('payslip_extrafieldtype', 'fixed_values',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtraFieldType.model'
        db.delete_column('payslip_extrafieldtype', 'model')

        # Deleting field 'ExtraFieldType.fixed_values'
        db.delete_column('payslip_extrafieldtype', 'fixed_values')
    ...
    models = {
        ...
        'payslip.extrafieldtype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'payslip.payment': {
